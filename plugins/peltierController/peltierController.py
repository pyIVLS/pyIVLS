...
class peltierController:
    ...
    def getData(self):
        ...
        """
        dataOrder = ["","Setpoint:", "T1:", "T2:","T1_ref:","T2_ref:","actionasnum","action","mode","kp=","ki=","kd=","lowlimit=", "highlimit=","menu=","rota=","power=","power=",""]
        numericValues = [1,2,3,4,5,6,9,10,11,12,13,14,16]# %what numeric values should be extracted dataOutput
        stringValues = [7,8,15,17]# %what string values should be extracted from dataOutput
        dataOutput = {}
        dataOutput["raw"]=""
        try:
                with self.lock:
