...
try:
    from PySide6.QtWidgets import QApplication, QComboBox, QGroupBox, QSpinBox
...
class TestTouchDetect:
    ...
    def test_manipulator_measurement_setup_lo_channel(self):
        ...
        status, _ = self.touch_detect._manipulator_measurement_setup(self.mock_mm, self.mock_smu, self.mock_con, info)
