...
from oousb2000_mdiwidget import Ui_previewForm
from oousb2000_settingswidget import Ui_Form
...
class OOUSB2000_SW(QtWidgets.QWidget, Ui_Form):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setupUi(self)


class OOUSB2000_MDI(QtWidgets.QWidget, Ui_previewForm):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setupUi(self)
...
class OOUSB2000_GUI(QObject):
    ...
    def __init__(self, verbose=False):
        ...
        self.settingsWidget = OOUSB2000_SW()
        self.previewWidget = OOUSB2000_MDI()
    ...
    def _spectrometerMakeHeader(self, varDict=None, separator=";"):
