################################################################################
## Form generated from reading UI file 'specSMUTime_settingsWidget.ui'
##
...
class Ui_Form:
    def setupUi(self, Form):
        ...
        self.verticalLayout_4.addWidget(self.groupBox, 0, Qt.AlignmentFlag.AlignLeft)
        ...
        self.lineEdit_Start.setMaximumSize(QSize(100, 16777215))
        ...
        self.lineEdit_End.setMaximumSize(QSize(100, 16777215))
        ...
        self.lineEdit_Points.setMaximumSize(QSize(50, 16777215))
        ...
        self.lineEdit_Limit.setMaximumSize(QSize(100, 16777215))
        ...
        self.lineEdit_NPLC.setMaximumSize(QSize(100, 16777215))
        ...
        self.lineEdit_Pause.setMaximumSize(QSize(50, 16777215))
        ...
        self.lineEdit_Delay.setMaximumSize(QSize(50, 16777215))
        ...
        self.lineEdit_time = QLineEdit(self.groupBox_2)
        self.lineEdit_time.setObjectName("lineEdit_time")
        self.lineEdit_time.setMaximumSize(QSize(100, 16777215))

        self.horizontalLayout_15.addWidget(self.lineEdit_time)
        ...
        self.lineEdit_period = QLineEdit(self.groupBox_2)
        self.lineEdit_period.setObjectName("lineEdit_period")
        self.lineEdit_period.setMaximumSize(QSize(100, 16777215))

        self.horizontalLayout_15.addWidget(self.lineEdit_period)
        ...
        self.verticalLayout.addWidget(self.groupBox_2, 0, Qt.AlignmentFlag.AlignLeft)
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox_2.setTitle(QCoreApplication.translate("Form", "Time", None))
        self.label_4.setText(QCoreApplication.translate("Form", "Time", None))
        self.label_8.setText(QCoreApplication.translate("Form", "s", None))
        self.label_9.setText(QCoreApplication.translate("Form", "Period", None))
        self.label_10.setText(QCoreApplication.translate("Form", "s", None))
