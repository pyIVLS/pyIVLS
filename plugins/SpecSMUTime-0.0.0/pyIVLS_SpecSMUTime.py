...
The proper implementation may be found in SpecSMU directory (SpecSMUTime_GUI.py).
...
class pyIVLS_SpecSMUTime_plugin:
    ...
    def set_function(self, function_dict):
        ...
        _is_valid, missing = self.specsmu.dm.set_available_dependency_functions(function_dict)
    ...
    def get_plugin_settings(self, args=None):
        ...
        if args is None or args.get("function") == self.function:
            ...
            _status, settings = self.specsmu.parse_settings_widget()
