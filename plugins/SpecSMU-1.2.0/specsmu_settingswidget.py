################################################################################
## Form generated from reading UI file 'specSMU_settingsWidget.ui'
##
...
class Ui_Form:
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 1141, 1002))
        ...
        self.groupBox_HWtrigger = QGroupBox(self.groupBox_general)
        self.groupBox_HWtrigger.setObjectName("groupBox_HWtrigger")
        self.groupBox_HWtrigger.setEnabled(True)
        self.verticalLayout_61 = QVBoxLayout(self.groupBox_HWtrigger)
        self.verticalLayout_61.setObjectName("verticalLayout_61")
        self.HLayoutBox_HWtrigger = QHBoxLayout()
        self.HLayoutBox_HWtrigger.setObjectName("HLayoutBox_HWtrigger")
        self.HLyoutBox_HWtrig_pulse = QHBoxLayout()
        self.HLyoutBox_HWtrig_pulse.setObjectName("HLyoutBox_HWtrig_pulse")
        self.HLyoutBox_HWtrig_pulse.setSizeConstraint(QLayout.SizeConstraint.SetDefaultConstraint)
        self.HLyoutBox_HWtrig_pulse.setContentsMargins(0, -1, -1, -1)
        self.label_HWtrig_pulse = QLabel(self.groupBox_HWtrigger)
        self.label_HWtrig_pulse.setObjectName("label_HWtrig_pulse")

        self.HLyoutBox_HWtrig_pulse.addWidget(self.label_HWtrig_pulse)

        self.lineEdit_HWtrig_pulse = QLineEdit(self.groupBox_HWtrigger)
        self.lineEdit_HWtrig_pulse.setObjectName("lineEdit_HWtrig_pulse")

        self.HLyoutBox_HWtrig_pulse.addWidget(self.lineEdit_HWtrig_pulse)

        self.label_HWtrig_pulse_units = QLabel(self.groupBox_HWtrigger)
        self.label_HWtrig_pulse_units.setObjectName("label_HWtrig_pulse_units")

        self.HLyoutBox_HWtrig_pulse.addWidget(self.label_HWtrig_pulse_units)

        self.horizontalSpacer2 = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.HLyoutBox_HWtrig_pulse.addItem(self.horizontalSpacer2)

        self.HLayoutBox_HWtrigger.addLayout(self.HLyoutBox_HWtrig_pulse)

        self.HLayoutBox_digio = QHBoxLayout()
        self.HLayoutBox_digio.setObjectName("HLayoutBox_digio")
        self.HLayoutBox_digio.setContentsMargins(0, -1, -1, -1)
        self.label_digio = QLabel(self.groupBox_HWtrigger)
        self.label_digio.setObjectName("label_digio")
        self.label_digio.setMinimumSize(QSize(75, 0))

        self.HLayoutBox_digio.addWidget(self.label_digio)

        self.spinBox_digio = QSpinBox(self.groupBox_HWtrigger)
        self.spinBox_digio.setObjectName("spinBox_digio")
        self.spinBox_digio.setMinimumSize(QSize(50, 0))
        self.spinBox_digio.setMinimum(1)
        self.spinBox_digio.setMaximum(8)

        self.HLayoutBox_digio.addWidget(self.spinBox_digio)

        self.horizontalSpacer_2 = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.HLayoutBox_digio.addItem(self.horizontalSpacer_2)

        self.HLayoutBox_HWtrigger.addLayout(self.HLayoutBox_digio)

        self.HLayoutBox_powerPulse = QHBoxLayout()
        self.HLayoutBox_powerPulse.setObjectName("HLayoutBox_powerPulse")
        self.HLayoutBox_powerPulse.setContentsMargins(0, -1, -1, -1)
        self.label_powerPulse = QLabel(self.groupBox_HWtrigger)
        self.label_powerPulse.setObjectName("label_powerPulse")

        self.HLayoutBox_powerPulse.addWidget(self.label_powerPulse)

        self.lineEdit_powerPulse = QLineEdit(self.groupBox_HWtrigger)
        self.lineEdit_powerPulse.setObjectName("lineEdit_powerPulse")

        self.HLayoutBox_powerPulse.addWidget(self.lineEdit_powerPulse)

        self.label_powerPulse_unit = QLabel(self.groupBox_HWtrigger)
        self.label_powerPulse_unit.setObjectName("label_powerPulse_unit")

        self.HLayoutBox_powerPulse.addWidget(self.label_powerPulse_unit)

        self.horizontalSpacer_3 = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.HLayoutBox_powerPulse.addItem(self.horizontalSpacer_3)

        self.HLayoutBox_HWtrigger.addLayout(self.HLayoutBox_powerPulse)

        self.HLayoutBox_HWtrigger.setStretch(0, 2)
        self.HLayoutBox_HWtrigger.setStretch(1, 2)
        self.HLayoutBox_HWtrigger.setStretch(2, 2)

        self.verticalLayout_61.addLayout(self.HLayoutBox_HWtrigger)

        self.verticalLayout.addWidget(self.groupBox_HWtrigger)
        ...
        self.HBoxLayout_pulsedLine1.addItem(self.horizontalSpacer_31)
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox_HWtrigger.setTitle(QCoreApplication.translate("Form", "HW Trigger", None))
        self.label_HWtrig_pulse.setText(QCoreApplication.translate("Form", "HW trigger pulse width", None))
        self.lineEdit_HWtrig_pulse.setText(QCoreApplication.translate("Form", "1", None))
        self.label_HWtrig_pulse_units.setText(QCoreApplication.translate("Form", "ms", None))
        self.label_digio.setText(QCoreApplication.translate("Form", "SMU IO line", None))
        self.label_powerPulse.setText(QCoreApplication.translate("Form", "Extension of the power pulse", None))
        self.lineEdit_powerPulse.setText(QCoreApplication.translate("Form", "0,5", None))
        self.label_powerPulse_unit.setText(QCoreApplication.translate("Form", "ms", None))
