################################################################################
## Form generated from reading UI file 'oousb2000_settingsWidget.ui'
##
...
class Ui_Form:
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 848, 524))
        ...
        self.horizontalLayout_4 = QHBoxLayout(self.connectBox)
        ...
        self.horizontalLayout_4.addWidget(self.connectionIndicator)
        ...
        self.integ_spinBox = QSpinBox(self.boxSettings)
        self.integ_spinBox.setObjectName("integ_spinBox")
        self.integ_spinBox.setMinimum(1)
        self.integ_spinBox.setMaximum(100000)

        self.horizontalLayout_10.addWidget(self.integ_spinBox)
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox_general.setTitle(QCoreApplication.translate("Form", "Ocean Optics USB2000 settings", None))
        ...
        self.correctionCheck.setText(QCoreApplication.translate("Form", "correct dark counts", None))
